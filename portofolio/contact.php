...
<body>
    <div id="app">
        ...
        while ($pr = mysqli_fetch_array($query)) {
            echo "<tr>";
            echo "<td>" . $pr['id_contact'] . "</td>";
            echo "<td>" . $pr['nama'] . "</td>";
            echo "<td>" . $pr['email'] . "</td>";
            echo "<td>" . $pr['pesan'] . "</td>";

            echo "<td>";
            // echo "<a class='btn btn-warning text-white' href='editproject.php?id_project=" . $pr['id_contact'] .  "'>Edit</a> ";
            echo "<a class='btn btn-danger' href='hapuscontact.php?id_contact=" . $pr['id_contact'] . "'>Hapus</a> ";
            echo "</td>";
            echo "</tr>";
        }
        ?>
